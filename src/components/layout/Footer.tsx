...
export default function Footer() {
  return (
    <footer className="relative overflow-hidden bg-[#071b12] text-white">
      ...
      <div className="pointer-events-none absolute -right-40 bottom-0 h-96 w-96 rounded-full bg-[#d71920]/5 blur-3xl" />
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-12 py-14 lg:grid-cols-12 lg:gap-10">
          ...
          <div className="lg:col-span-5">
            <div className="flex items-center gap-4">
              <div className="relative flex h-14 w-14 shrink-0 items-center justify-center overflow-hidden rounded-2xl bg-white shadow-lg">
                <div className="absolute inset-x-0 top-0 h-1.5 bg-[#008751]" />
                <div className="absolute inset-x-0 bottom-0 h-1.5 bg-[#d71920]" />
                <span className="text-2xl font-black text-[#008751]">I</span>
              </div>

              <div>
                <h3 className="text-xl font-extrabold tracking-tight sm:text-2xl">
                  Ifeanyi <span className="text-[#008751]">4</span> Nkanu
                </h3>
            ...
            <div className="mt-7 max-w-md">
              <p className="text-[15px] leading-7 text-white/60">
                Building a stronger Nkanu West through responsive
                representation, inclusive leadership, sustainable development
                and a renewed commitment to our people.
              </p>
            </div>
            ...
            <div className="mt-7 border-l-2 border-[#008751] pl-4">
              ...
              <p className="mt-1 text-xs text-white/40">
                Together, we can build the Nkanu West we deserve.
              </p>
            </div>
          </div>
        ...
        <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-r from-[#008751]/15 via-white/[0.03] to-[#d71920]/10 px-5 py-6 sm:px-7">
          <div className="absolute left-0 top-0 h-full w-1 bg-[#008751]" />
          <div className="absolute right-0 top-0 h-full w-1 bg-[#d71920]" />

          <div className="flex flex-col items-center justify-between gap-4 text-center sm:flex-row sm:text-left">
            <div>
              <p className="text-sm font-bold text-white">
                Nkanu West, our future is in our hands.
              </p>
              <p className="mt-1 text-xs text-white/45">
                Join the movement for purposeful representation.
              </p>
            </div>
        ...
        <div className="mt-8 border-t border-white/10 py-7">
          <div className="flex flex-col items-center justify-between gap-4 text-center sm:flex-row sm:text-left">
            <p className="text-xs text-white/40">
              &copy; {new Date().getFullYear()} Ifeanyi 4 Nkanu Campaign.
